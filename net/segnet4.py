...
def inference(images, phase_train, is_training = True,weights=None):
    ...
    net = conv_layer_with_bn(net, [3, 3, 2048, 1024], phase_train, False, name="decode_reduce_4_2")
    net = conv_layer_with_bn(net, [3, 3, 1024, 512], phase_train, False, name="decode_reduce_4_1")
    ...
    net = conv_layer_with_bn(net, [3, 3, 256, 256], phase_train, False, name="decode_reduce_2_2")
    net = conv_layer_with_bn(net, [3, 3, 256, 128], phase_train, False, name="decode_reduce_2_1")
